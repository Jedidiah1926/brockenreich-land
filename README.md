...
있습니다 (성장은 바닐라처럼 뼛가루 등에 맡김). 나머지 12종은 심은 뒤 다음 기본 시간이 지나면 자동으로
...
나무 묘목은 정글을 제외한 오크/가문비/자작/아카시아/짙은참나무/벚나무/맹그로브 순묘가 "나무 묘목" 시간을,
정글 나무 묘목만 별도의 훨씬 긴 시간을 씁니다. 다크 오크처럼 항상 2×2로만 자라는 "큰 나무"나, 정글을 2×2로
심어 큰 나무로 키우는 경우는 이 표에 없는 별도의 고정 시간이 없습니다 — 대신 2×2로 심어진 4그루 중 어느 한
그루의 타이머가 먼저 끝나는 순간 바닐라 뼛가루 로직이 나머지 3그루가 이미 심어져 있는 걸 그대로 인식해서
큰 나무로 자라기 때문에, 특별한 처리 없이도 자연스럽게 동작합니다.
