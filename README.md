...
| `potion` | 투척용 포션 효과가 이 구역 안의 엔티티에게 적용되지 못하게 막음 (잔류형 포션은 이 구역 안에서 잔류 구름 자체가 생기지 않음) |
| `explosion` | TNT, 엔드 수정, 크리퍼, 위더, 침대/속박의 닻 등 모든 폭발로부터 이 구역 안의 블록이 파괴되지 않게 막음 (경계에 걸친 폭발은 구역 밖 블록만 정상 파괴됨) |
